...
<head>
    ...
    <script>
        const tabIdBtnChamp= [document.getElementById('nomModif'),document.getElementById('prenomModif'), document.getElementById('emailModif'),document.getElementById('phoneModif')];
